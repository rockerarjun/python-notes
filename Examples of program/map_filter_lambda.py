...
print("\n using filter(),lambda")
f1=list(filter(lambda x:(x[0]+x[1]) %2==0,[(x,x*2) for x in range(1,11)])) #[3,6,9,....30]
print(f1)
f2=list(filter(lambda x:(x[0]+x[1]) %5==0,f1))
print(f2)
print(reduce(lambda a,b: a if (a > b) else b,f2[0]))
